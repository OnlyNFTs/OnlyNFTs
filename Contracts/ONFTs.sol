...
/*
    ...
    #OnlyNFTs
     ...
     4% liquidty and marketing tax is collected and half of it is added to the Liquidity and the other half is sent a wallet
    created for marketing/development
     1% burn tax is collected and burnt to reduce the supply
...
contract OnlyNFTs is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = 0xa5c812aBAbAe876F98D732A6CC03F7291e93F488; // Marketing Address
    ...
    uint256 private __liquidityFee;

    string private _name = "OnlyNFTs";
    string private _symbol = "ONFTs";
    ...
    uint256 private _previousLiquidityFee = __liquidityFee;
    
    uint256 public _maxTxAmount = 5000000 * 10**18;
    uint256 private minimumTokensBeforeSwap = 500000 * 10**18; 
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 liquidityHalf = contractTokenBalance.div(2);
        uint256 marketingHalf = contractTokenBalance.sub(liquidityHalf);
        
        uint256 firstHalf = liquidityHalf.div(2);
        uint256 remainingHalf = liquidityHalf.sub(firstHalf);
        
        uint256 initialBalance = address(this).balance;
         // swap tokens for ETH
        swapTokensForEth(marketingHalf);
